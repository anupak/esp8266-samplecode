...
static const coap_endpoint_path_t path_light2 = {1, {"light2"}};
...
const coap_endpoint_t endpoints[] =
{
    ...
    {COAP_METHOD_GET, handle_get_light1, &path_light2, "ct=1"},
    {COAP_METHOD_PUT, handle_put_light1, &path_light2, NULL},
